![](https://github.com/Mathis-FABRE/DLCP-Projet/workflows/Run%20tests/badge.svg)
...
- [DevCommeLesPros-2021-Projet](#devcommelespros-2021-projet)
- [Table des matières](#table-des-matières)
- [Objectif](#objectif)
- [Spécifications fonctionelles](#spécifications-fonctionelles)
  - [Fonctionalités pour un restaurateur](#fonctionalités-pour-un-restaurateur)
  - [Fonctionalités pour un livreur](#fonctionalités-pour-un-livreur)
  - [Fonctionalités pour un client](#fonctionalités-pour-un-client)
- [Spécifications de conception](#spécifications-de-conception)
  - [Interface](#interface)
  ...
  - [Journal](#journal)
  - [Langage de programmation, paramètres de compilateur et proscriptions](#langage-de-programmation-paramètres-de-compilateur-et-proscriptions)
- [Instructions de travail](#instructions-de-travail)
  - [Modules/Bibliothèques](#modulesbibliothèques)
  - [Tests](#tests)
  ...
  - [Documentation](#documentation)
    ...
    - [Documentation pour les ingénieurs](#documentation-pour-les-ingénieurs)
  - [Phases de développement](#phases-de-développement)
    - [Pré-alpha](#pré-alpha)
    - [Alpha](#alpha)
    - [Beta](#beta)
    - [Livraison](#livraison)
    - [Support et fonctionalités additionelles](#support-et-fonctionalités-additionelles)
- [Évaluation](#évaluation)
  - [La base de code](#la-base-de-code)
  - [L'application](#lapplication)
  - [La méthode de développement](#la-méthode-de-développement)
